...
工程地址：[GitHub](https://github.com/HuskyTGame/CustomBehaviorTree) and [网盘](https://pan.baidu.com/s/124-kkyyPO-2uBgs6UvzBsQ)（提取码：yu6b）
...
| 算法\地图大小 | 40 * 40  | 70 * 70  | 100 * 100  |
| :--: | :--: | :--: | :--: |
| 未优化的 AStar  | 1.7ms  | 7.4ms  | 8.7ms  |
| 优化后的 AStar  | 0.8ms  | 2.7ms  | 5.8ms  |
